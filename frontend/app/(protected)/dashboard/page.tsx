      ...
      <div className="px-6 py-6 flex-1 max-w-4xl w-full mx-auto space-y-4">
        <div className="bg-card border border-border rounded-2xl p-6 shadow-xl">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-border bg-secondary px-4 py-3 text-foreground text-sm resize-none focus:outline-none focus:border-chart-2 focus:ring-1 focus:ring-chart-2/20 transition-all duration-200 placeholder:text-muted-foreground/50"
            rows={3}
          />
          <div className="flex justify-end mt-4">
            <button
              ...
              className="px-6 py-2.5 rounded-full bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed disabled:shadow-none transition-all duration-200"
            >
              ...
              <>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-all duration-200"
                  >
                    Tinjau & Setujui
                  </button>
                </div>
