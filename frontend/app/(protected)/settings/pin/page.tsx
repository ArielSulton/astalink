      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-xl space-y-5">
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
            className="w-full text-center tracking-[0.8em] font-mono font-bold text-lg bg-secondary border border-border rounded-xl px-4 py-2.5 text-foreground placeholder:text-muted-foreground/40 placeholder:tracking-normal focus:outline-none focus:border-chart-2 focus:ring-1 focus:ring-chart-2/20 transition-all duration-200"
          />
        </div>
