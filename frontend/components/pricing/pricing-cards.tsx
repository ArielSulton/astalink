...
const PRICING_TIERS: readonly Tier[] = [
  {
    ...
    icon: Brain,
    features: [
      { name: "Analisis portofolio dasar (3 saham)", included: true },
      { name: "Sinyal teknikal RSI, MACD, MA", included: true },
      { name: "Verifikasi regulasi OJK otomatis", included: true },
      { name: "Riwayat chat AI (7 hari)", included: true },
      { name: "Notifikasi email harian", included: true },
      { name: "Analisis fundamental mendalam", included: false },
      { name: "Backtesting strategi", included: false },
  ...
  },
  {
    ...
    icon: TrendingUp,
    features: [
      { name: "Analisis portofolio tak terbatas", included: true },
      { name: "Sinyal teknikal lengkap + custom", included: true },
      { name: "Verifikasi regulasi OJK otomatis", included: true },
      { name: "Riwayat chat AI tak terbatas", included: true },
      { name: "Notifikasi real-time (WA + Email)", included: true },
      { name: "Analisis fundamental mendalam", included: true },
      { name: "Backtesting strategi (5 tahun)", included: true },
      { name: "API access (1.000 req/bulan)", included: true },
      { name: "Prioritas support (24 jam)", included: true },
      { name: "Ekspor laporan PDF/Excel", included: true },
      { name: "Watchlist tak terbatas", included: true },
      { name: "Alert harga & volume custom", included: true },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Multi-user workspace (5+ seats)", included: true },
      { name: "White-label reporting", included: true },
      { name: "API access tak terbatas", included: true },
      { name: "Webhook & integrasi broker", included: true },
      { name: "Custom AI model fine-tuning", included: true },
      { name: "Dedicated account manager", included: true },
      { name: "SLA 99.9% + support 24/7", included: true },
      { name: "Audit trail & compliance logging", included: true },
      { name: "On-premise deployment option", included: true },
      { name: "Custom regulasi & whitelist", included: true },
      { name: "Training & onboarding tim", included: true },
    ],
